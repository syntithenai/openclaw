          ...
          Type.Object(
            {
              ...
              sttEndpoint: Type.Optional(Type.String()),
              sttTimeoutMs: Type.Optional(Type.Integer({ minimum: 0 })),
              sttLanguage: Type.Optional(Type.String()),
              ttsProvider: Type.Optional(Type.String()),
              ttsEndpoint: Type.Optional(Type.String()),
              ttsTimeoutMs: Type.Optional(Type.Integer({ minimum: 0 })),
              audioDevice: Type.Optional(Type.String()),
              voiceWakeEnabled: Type.Optional(Type.Boolean()),
              voiceWakeWords: Type.Optional(Type.String()),
              voiceWakeConfidence: Type.Optional(Type.Number({ minimum: 0, maximum: 1 })),
              voiceWakePhraseTimeoutMs: Type.Optional(Type.Integer({ minimum: 0 })),
            },
            { additionalProperties: false },
          ),
        ),
